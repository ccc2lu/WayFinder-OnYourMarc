    ...
    <div class="columns">
      ...
      <div class="column">
        ...
        <nav class="level">
          ...
          <br><br>
          <span>
                      <input class="button is-info is-medium" type="button" onclick="sendFile()" value="upload file">
                    </span>
          <br><br>
          <div class="field">
  <label class="label">Message...</label>
  <div class="control">
   <!--   <textarea class="textarea" id="echoText" placeholder="Textarea">-->
    <div id="echotwo"></div>
  </div>
</div>
...
<script type="text/javascript">
		var webSocket = new WebSocket("ws://localhost:8098/websocketendpoint");
		//var echoText = document.getElementById("echoText");
		var echoTwo = document.getElementById("echotwo");
		//echoText.value = "";
